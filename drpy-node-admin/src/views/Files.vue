      ...
      <div class="card overflow-hidden">
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700 max-h-[600px] overflow-y-auto">
          ...
          >
            ...
            <span v-else-if="!isSupportedFile(file.name)" class="badge badge-gray text-xs">不支持预览</span>
      ...
      <div class="card overflow-hidden">
        <div v-if="selectedFile" class="h-full flex flex-col">
          ...
          <div class="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900">
            ...
            <!-- Image preview -->
            <img v-else-if="fileType === 'image'" :src="imageDataUrl" :alt="selectedFile?.name" class="max-w-full h-auto" />
            <!-- Text preview -->
